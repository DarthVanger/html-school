...
<p>
  Каждая строка в { } - это имя свойства, и значение свойства. Синтаксис простой: всего 2 знака используется :). Двоеточие после имени свойства, точка запятой - в конце строки. Все)) <code>свойство: значение;</code>
</p>
<p>
  Если по-русски
</p>
