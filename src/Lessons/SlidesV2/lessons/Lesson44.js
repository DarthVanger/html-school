    ...
    <article>
      <section class="content">
        ...
        <ol type="i" style="padding-left: 2.5em">
          ...
          <li>Створюємо файл portfolio.js, який експортує HTML Елемент з будь-яким текстом всередині. Імпортуємо його в menu.js</li>
          <li>В menu.js робимо кнопку, по натисненню на яку буде показуватися сторінка Portfolio</li>
          <li>Створюємо файл about.js, який експортує HTML Елемент з будь-яким текстом всередині. Імпортуємо його в menu.js</li>
          ...
          <li>Створюємо файл pet-projects.js, який експортує HTML Елемент з будь-яким текстом всередині. Імпортуємо його в menu.js</li>
